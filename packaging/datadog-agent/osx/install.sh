...
$sudo_cmd mkdir -p /etc/dd-agent
$sudo_cmd cp -R $install_dir/conf/* /etc/dd-agent
$sudo_cmd ln -sf $install_dir/bin/datadog-agent /usr/bin/datadog-agent
